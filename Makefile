...
CUTLASS_RESULT_gumbel-sass := 19-gumbel-sass
...
modal-cutlass:
	...
	@test -z "$(CUTLASS_VARIANT_CHECK_$(GATE))" || \
		PYTHONPATH=src $(PYTHON) -m fused_mm_sampling.cutlass_experiments --validate "$(CUTLASS_VARIANT)"
