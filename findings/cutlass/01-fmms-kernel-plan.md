...
The following B200 median-latency table is the current reference snapshot in
microseconds.
It is included to make the present performance state visible while the unified
four-provider runner is being implemented.
These values were generated by different Modal experiments with different
provider sets and repetition packets, so they are directional context rather
than a directly comparable four-provider result.
The four-way experiment above must replace this table for future performance
decisions.

| V | D | H | Triton FlashSampling | cuBLAS + argmax | CUTLASS greedy | CUTLASS FlashSampling |
|---:|---:|---:|---:|---:|---:|---:|
| 151,936 | 4,096 | 64 | 250 | 249 | 242 | 280 |
| 151,936 | 4,096 | 128 | 350 | 272 | 258 | 365 |
| 151,936 | 4,096 | 256 | 546 | 337 | 333 | 575 |
| 128,256 | 8,192 | 64 | 367 | 415 | 356 | 363 |
| 128,256 | 8,192 | 128 | 485 | 452 | 388 | 432 |
| 128,256 | 8,192 | 256 | 786 | 505 | 495 | 613 |

The Triton and current CUTLASS FlashSampling values come from the accurate
multi-warpgroup timing experiments.
The cuBLAS plus argmax and CUTLASS greedy values come from the earlier B200
greedy baseline packet.
The source artifacts are `benchmarking/modal-results/cutlass/experiments/`
and `benchmarking/modal-results/cutlass/10-greedy-performance/case-summary.csv`.
