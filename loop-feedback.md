...
When you hit on infrastructure friction, like a very slow build, or anything else that materially slows down the development/experimentation process, document it precisely in a markdown file, so a future infra agent can take a look at this concrete workload and optimize it for you. You are not alone in this, and we can help you if you communicate the problem clearly.
